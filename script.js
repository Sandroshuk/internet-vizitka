...
const dictionaries = {
  ru: {
    ...
    audienceTitle: "Если о вас спрашивают в переписке, вам нужна понятная ссылка",
    ...
    inside2Title: "Услуги",
    inside2Text: "понятно, без длинных объяснений",
  ...
  en: {
    ...
    themeLabels: {
      ...
      plum: "Plum and Pearl",
      pistachio: "Pistachio",
      powder: "Powder and Sky",
    },
    audienceKicker: "For whom",
    audienceTitle: "If people ask about you in messages, you need a clear link",
    ...
    inside2Text: "clear, without long explanations",
  ...
  pl: {
    ...
    themeLabels: {
      ...
      plum: "Śliwka i perła",
      pistachio: "Pistacja",
      powder: "Puder i niebo",
    },
    audienceKicker: "Dla kogo",
    audienceTitle: "Jeśli ludzie pytają o Ciebie w wiadomościach, potrzebujesz jasnego linku",
    ...
    inside2Title: "Usługi",
    inside2Text: "jasno, bez długich opisów",
