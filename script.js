...
const dictionaries = {
  ru: {
    ...
    priceValue: "Стоимость для вас: 1500 ₽",
    priceNote: "Страница, которую можно отправлять снова и снова. Без расходов на домен и хостинг на старте. После утверждения небольшие правки — от 800 ₽.",
  ...
  en: {
    ...
    priceValue: "Your price: 1500 ₽",
    priceNote: "A page you can send again and again. No domain or hosting costs at the start. Small edits after approval start from 800 ₽.",
  ...
  pl: {
    ...
    priceValue: "Cena dla Ciebie: 1500 ₽",
    priceNote: "Strona, którą można wysyłać wiele razy. Bez kosztów domeny i hostingu na start. Drobne poprawki po akceptacji od 800 ₽.",
