...
const dictionaries = {
  ru: {
    ...
    audienceTitle: "Чтобы вас легко находили, а визитка не терялась в соцсетях",
  ...
  en: {
    ...
    audienceTitle: "So people can find you easily and your page does not get lost in social feeds",
  ...
  pl: {
    ...
    audienceTitle: "Żeby łatwo było Cię znaleźć, a wizytówka nie ginęła w social mediach",
