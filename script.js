...
const dictionaries = {
  ru: {
    ...
    priceValue: "не дороже привычных 10 чашек кофе",
    priceNote: "Около 10 чашек кофе за страницу, которую можно отправлять снова и снова. Без расходов на домен и хостинг на старте.",
  ...
  en: {
    ...
    priceValue: "no more than 10 usual cups of coffee",
    priceNote: "About 10 cups of coffee for a page you can send again and again. No domain or hosting costs at the start.",
  ...
  pl: {
    ...
    priceValue: "nie drożej niż 10 zwykłych kaw",
    priceNote: "Około 10 kaw za stronę, którą można wysyłać wiele razy. Bez kosztów domeny i hostingu na start.",
