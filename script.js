...
const dictionaries = {
  ru: {
    ...
    heroLeadIntro: "Для бьюти-мастера, ремесленника, специалиста или творческого человека:",
    heroLeadWho: "кто вы",
    ...
    styleTitle: "• покрутите цвет и шрифт",
    styleNote: "Так можно будет подобрать стиль под вас.",
    ...
    pricingNote: "Удобным способом, фискальный чек.",
    pricePlan1Name: "База",
    pricePlan1Value: "1590 ₽",
    pricePlan1Text: "Правки после публикации — 800 ₽.",
    ...
    pricePlan3Text: "Три бесплатные правки или дополнения после публикации.",
    themeLabels: {
    ...
    audienceTitle: "• кто хочет быть более заметен",
    audienceNote: "Одна ссылка, которую можно открыть в телефоне, сохранить на главный экран и пересылать снова и снова. Без расходов на домен и хостинг на старте.",
    aud1Title: "Маникюр",
    ...
    insideTitle: "• ваша короткая презентация",
    insideNote: "Сильные стороны и понятное предложение.",
  ...
  en: {
    ...
    heroLeadIntro: "For a beauty pro, craftsperson, specialist or creative person:",
    ...
    styleTitle: "• play with color and font",
    styleNote: "This helps choose a style that fits you.",
    ...
    pricingNote: "Convenient payment, official receipt.",
    pricePlan1Name: "Base",
    pricePlan1Value: "1590 ₽",
    pricePlan1Text: "Edits after publication are 800 ₽.",
    pricePlan2Name: "Start",
    pricePlan2Value: "1990 ₽",
    pricePlan2Text: "One-time publication without later edits or additions.",
    pricePlan3Name: "Plus",
    pricePlan3Value: "2990 ₽",
    pricePlan3Text: "Three free edits or additions after publication.",
    themeLabels: {
    ...
    audienceTitle: "• for people who want to be easier to notice",
    audienceNote: "One link people can open on a phone, save to the home screen and share again and again. No domain or hosting costs at the start.",
    aud1Title: "Manicure",
    ...
    insideTitle: "• your short presentation",
    insideNote: "Strengths and a clear offer.",
  ...
  pl: {
    ...
    heroLeadIntro: "Dla beauty mastera, rzemieślnika, specjalisty albo osoby kreatywnej:",
    ...
    styleTitle: "• zmień kolor i krój pisma",
    styleNote: "Tak można dobrać styl pod Ciebie.",
    ...
    pricingNote: "Wygodna płatność, paragon fiskalny.",
    pricePlan1Name: "Baza",
    pricePlan1Value: "1590 ₽",
    pricePlan1Text: "Poprawki po publikacji — 800 ₽.",
    pricePlan2Name: "Start",
    pricePlan2Value: "1990 ₽",
    pricePlan2Text: "Jednorazowa publikacja bez późniejszych poprawek i dodatków.",
    pricePlan3Name: "Plus",
    pricePlan3Value: "2990 ₽",
    pricePlan3Text: "Trzy bezpłatne poprawki albo dodatki po publikacji.",
    themeLabels: {
    ...
    audienceTitle: "• dla tych, którzy chcą być bardziej widoczni",
    audienceNote: "Jeden link, który można otworzyć w telefonie, zapisać na ekranie głównym i przesyłać wiele razy. Bez kosztów domeny i hostingu na start.",
    aud1Title: "Manicure",
    ...
    insideTitle: "• twoja krótka prezentacja",
    insideNote: "Mocne strony i jasna oferta.",
