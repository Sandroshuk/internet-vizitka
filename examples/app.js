const examples = {
  ...
  consulting: {
    ...
    lead: "Понятная консультация юриста: с чем можно обратиться, сколько стоит и как записаться.",
    accent: "#a29bfe",
    bg: "#f3f4f7",
    ...
    works: [
      ["Документы", "договоры, заявления, претензии"],
      ["Семья", "алименты, раздел, соглашения"],
      ["План", "что делать дальше по шагам"],
    ],
    story: "Татьяна помогает спокойно разобраться в ситуации до того, как человек начнет писать длинные сообщения в разные чаты. На странице сразу видны темы, стоимость и первый шаг.",
