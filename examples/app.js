const examples = {
  ...
  repair: {
    ...
    lead: "Мелкий ремонт, сборка и установка. На странице видно, с какими задачами можно обращаться.",
    accent: "#b2ac88",
    bg: "#e8eae6",
    ...
    story: "Работа по небольшим бытовым задачам: повесить, собрать, заменить, закрепить. Заранее видно, что можно прислать в заявку.",
  ...
  network: {
    ...
    lead: "Подбор товаров для здоровья и красоты: направления, отзывы и способ заказа собраны в одном месте.",
    accent: "#4caf8c",
    bg: "#fcfbe3",
    ...
    story: "В одном месте собраны товары для здоровья, красоты и дома. По ссылке можно посмотреть направления, примеры наборов, отзывы и сразу написать для подбора.",
